...
//            taskHolder.dateTimeText.setTextColor(Color.parseColor("#FF0000"));
        ...
        else if (holder instanceof HeaderViewHolder)
        {
            ...
            headerViewHolder.headerText.setText("Upcoming tasls");
        ...
        public void onClick(View v) {
            if (v.getId()==checkBox.getId())
            {
                if (checkBox.isChecked())
                {
                    ...
                    task.setCompletion_status(1);
                    taskViewModel.update(task);
                    view.setBackgroundResource(R.drawable.task_item_checked);
//                    Toast.makeText(v.getContext(), "Item checked!", Toast.LENGTH_SHORT).show();
                }
